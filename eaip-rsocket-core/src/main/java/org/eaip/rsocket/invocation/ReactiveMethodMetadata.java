...
import org.eaip.rsocket.metadata.*;
...
import static org.eaip.rsocket.constants.ReactiveStreamConstants.REACTIVE_STREAMING_CLASSES;
...
public class ReactiveMethodMetadata extends ReactiveMethodSupport {
    ...
    /**
     * service full name, format as org.eaip.user.UserService
     */
