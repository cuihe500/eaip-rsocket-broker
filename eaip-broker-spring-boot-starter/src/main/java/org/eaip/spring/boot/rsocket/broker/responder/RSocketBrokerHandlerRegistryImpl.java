...
import org.eaip.rsocket.upstream.ServiceInstancesChangedEvent;
import org.eaip.rsocket.upstream.UpstreamClusterChangedEvent;
import org.eaip.rsocket.utils.MurmurHash3;
...
import org.eaip.spring.boot.rsocket.broker.security.JwtPrincipal;
...
public class RSocketBrokerHandlerRegistryImpl implements RSocketBrokerHandlerRegistry {
    ...
    private CloudEventImpl<UpstreamClusterChangedEvent> getBrokerClustersEvent(Collection<RSocketBroker> rSocketBrokers, String topology) {
        ...
        return RSocketCloudEventBuilder.builder(upstreamClusterChangedEvent)
                .withDataschema(URI.create("rsocket:event:org.eaip.rsocket.upstream.UpstreamClusterChangedEvent"))
