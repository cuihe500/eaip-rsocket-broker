...
import org.eaip.rsocket.broker.EAIPRSocketBrokerServer;
 ...
 * @author CuiChangHe
 */
@Route(value = SystemView.NAV, layout = MainLayout.class)
public class SystemView extends VerticalLayout {
    ...
    public List<Tuple2<String, String>> systemInfo() {
        ...
        pairs.add(Tuples.of("Started Time", EAIPRSocketBrokerServer.STARTED_AT.format(DateTimeFormatter.ISO_DATE_TIME)));
        return pairs;
    }
}
